...
<Link to="/about" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style={{minheight: '400px'}}>
                <div class="position-relative h-100">
                    <img class="img-fluid position-absolute w-100 h-100" src="img/22-12-20_20-52-13.jpg" alt="" style={{objectfit: 'cover'}}  />
                </div>
            </div>
