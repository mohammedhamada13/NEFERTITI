...
const Home = () => {
  return (
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0   wow zoomIn">
    ...
    <Carousel >
      <Carousel.Item  className='wow zoomIn'>
        <img
          className="d-block w-100 ml-2"
          src="img/grilled-cheeseburger-sesame-bun-with-fresh-toppings-generative-ai_188544-12325.webp"
          alt="First slide"
        />
        <Carousel.Caption>
          <h3> NEFERTITI  label</h3>
      ...
      <Carousel.Item>
        <img
          ...
          src="img/juicy-piece-meat-wooden-board-generative-ai_169016-28803.webp"
          alt="Second slide"
        />
      ...
      <Carousel.Item>
        <img
          className="d-block w-100"
          src="img/freshly-italian-pizza-with-mozzarella-cheese-slice-generative-ai_188544-12347.webp"
          alt="Third slide"
        />
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style={{minheight: '400px'}}>
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="img/IMG-20230225-WA0013.jpg" alt="" style={{objectfit: "cover"}}/>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="section-title bg-white text-start text-primary pe-3">About Us</h6>
                    <h1 class="mb-4">Welcome to NEFERTITI</h1>
    ...
    <div class="container-xxl py-5 category">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">HERE ARE Categories</h1>
            </div>
            <div class="row g-3">
                ...
                <div class="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s" style={{minheight: '350px'}}>
                    <a class="position-relative d-block h-100 overflow-hidden" href="">
                        <img class="img-fluid position-absolute w-100 h-100" src="img/raw-marbled-ribeye-steak-butchers-knife-isolated_82893-9873.webp" alt="" style={{objectfit: 'cover'}}/>
                        <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style={{margin:  '1px'}}>
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="text-center">
                <h6 class="section-title bg-white text-center text-primary px-3">THE FOOTER</h6>
                <h1 class="mb-5">!</h1>
            </div>
